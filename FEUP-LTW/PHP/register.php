...
filter_var($typeUser, FILTER_SANITIZE_STRING);
filter_var($avatar, FILTER_SANITIZE_STRING);

// Validate all data of the form
if (empty($name) || empty($username)|| empty($email) || empty($password) || empty($confirm_password) || empty($typeUser)) {
...
$insert_query = "INSERT INTO users (username, email, name, password, userType, avatar) VALUES ('$username', '$email', '$name', '$password_hash', '$typeUser', '$avatar')";
